...
class HOTEL_MANAGEMENT:
    def __init__(self):
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        n = 1
                        self.Text1.insert(INSERT,"This room is occupied by: ")
                        self.Text1.insert(INSERT, "\n")
                        print("NAME-", "\t", "\t", s.name)
                        ...
                        self.Text1.insert(INSERT,"ADDRESS: ")
                        self.Text1.insert(INSERT, s.address)
                        self.Text1.insert(INSERT, "\n")
                        print("\n")
                        print("MOBILE NO.-", "  ", s.mobile_no)
                        self.Text1.insert(INSERT,"MOBILE NO.: ")
                        self.Text1.insert(INSERT, s.mobile_no)
                        self.Text1.insert(INSERT, "\n")
                        print("\n")
                        print("THEIR TOTAL BILL IS PhP.", s.price)
                        self.Text1.insert(INSERT,"TOTAL BILL: ")
                        self.Text1.insert(INSERT, "PhP ")
        ...
        root.title("GOLDSTAR HOTEL MANAGEMENT - CHECK ROOM")
        ...
        self.Label1.configure(background="#04151F")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font=font9)
        self.Label1.configure(foreground="#F1E67A")
        ...
        self.Button1.configure(background="#F1E67A")
        self.Button1.configure(disabledforeground="#a3a3a3")
        self.Button1.configure(font=font10)
        self.Button1.configure(foreground="#04151F")
        ...
        self.Message1.place(relx=0.155, rely=0.02, relheight=0.12, relwidth=0.7)
        self.Message1.configure(background="#04151F")
        self.Message1.configure(font=font11)
        self.Message1.configure(foreground="#F1E67A")
        self.Message1.configure(highlightbackground="#d9d9d9")
        self.Message1.configure(highlightcolor="black")
        self.Message1.configure(text='''CHECK ROOM INFORMATION''')
        self.Message1.configure(width=700)
        root.mainloop()
