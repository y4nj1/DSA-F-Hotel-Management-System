    ...
    def __init__(self):
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "Invalid input. Pease input a valid address.""\n")
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "Number of Days has been saved.""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "Invalid input. Please enter a valid number.""\n")
                    break
        ...
        def submit_clicked():
            if self.var1.get()==1 and self.var2.get()==0 and self.var3.get()==0 and self.var4.get()==0 and self.var5.get()==1 and self.var6.get()==0:
                ...
                self.Text1.insert(INSERT, "Invalid choice. Please input a valid option.""\n")
        ...
        root.title("GOLDSTAR HOTEL MANAGMENT - CHECK IN")
        root.resizable(0,0)
        ...
        self.Message1.place(relx=0.03, rely=0.11, relheight=0.79, relwidth=0.5)
        ...
        self.Message1.configure(text='''SELECTED MENU OPTION''')
        self.Message1.configure(width=510)

        self.Message2 = Message(self.Frame1)
        self.Message2.place(relx=0.52, rely=0.12, relheight=0.74, relwidth=0.07)
        self.Message2.configure(background="#04151F")
        self.Message2.configure(font=font11)
        self.Message2.configure(foreground="#F1E67A")
        ...
        self.Message3.configure(background="#04151F")
        self.Message3.configure(font=font11)
        self.Message3.configure(foreground="#F1E67A")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#04151F")
        ...
        self.Label4.place(relx=0.045, rely=0.285, height=47, width=329)
        self.Label4.configure(activebackground="#ffffff")
        self.Label4.configure(activeforeground="black")
        self.Label4.configure(background="#04151F")
        self.Label4.configure(disabledforeground="#bfbfbf")
        self.Label4.configure(font=font12)
        self.Label4.configure(foreground="#F1E67A")
        ...
        self.Label6.place(relx=0.33, rely=0.52, height=48, width=296)
        self.Label6.configure(activebackground="#ffffff")
        self.Label6.configure(activeforeground="black")
        self.Label6.configure(background="#04151F")
        self.Label6.configure(disabledforeground="#bfbfbf")
        self.Label6.configure(font=font13)
        self.Label6.configure(foreground="#F1E67A")
        ...
        self.Message4.configure(background="#04151F")
        self.Message4.configure(font=font13)
        self.Message4.configure(foreground="#F1E67A")
        ...
        self.Message5.configure(background="#04151F")
        self.Message5.configure(font=font13)
        self.Message5.configure(foreground="#F1E67A")
        ...
        self.Message7.configure(background="#04151F")
        self.Message7.configure(font=font15)
        self.Message7.configure(foreground="#F1E67A")
        ...
        self.Button4.configure(foreground="#04151F")
        ...
        self.Label1.place(relx=0.065, rely=0.41, height=44, width=300)
        ...
        self.Label1.configure(text='''LENGTH OF STAY (DAYS)''')
        ...
        self.Message8.configure(background="#04151F")
        self.Message8.configure(font=font13)
        self.Message8.configure(foreground="#F1E67A")
