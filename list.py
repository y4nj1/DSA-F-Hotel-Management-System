...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        root.title("GOLDSTAR HOTEL MANAGEMENT - GUEST LIST")
        ...
        self.Labelframe1.configure(foreground="#F1E67A")
        self.Labelframe1.configure(text='''COMPLETE GUEST LIST''')
        self.Labelframe1.configure(background="#04151F")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#66717E")
        self.Frame1.configure(highlightbackground="#ffffff")
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(width=355)

        self.Label1 = Label(self.Frame1)
        self.Label1.place(relx=0.32, rely=0.03, height=37, width=117)
        self.Label1.configure(activebackground="#ffffff")
        self.Label1.configure(activeforeground="black")
        self.Label1.configure(background="#66717E")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font=font11)
        self.Label1.configure(foreground="#04151F")
