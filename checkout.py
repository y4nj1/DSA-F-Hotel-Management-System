...
class New_Toplevel:
    ...
    def __init__(self):
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                ...
                try:
                    ...
                    if n == 0:
                        ...
                        self.Text1.insert(INSERT, "THANK YOU  " + name1.upper() + " FOR VISTING GOLDSTAR HOTELS!""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
                ...
                self.Text1.insert(INSERT, "Invalid input. Please input a valid room number.""\n")
        ...
        root.title("GOLDSTAR HOTEL MANAGEMENT - CHECK OUT")
